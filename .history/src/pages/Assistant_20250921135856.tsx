...
const Assistant = () => {
  const [sessions, setSessions] = useState<Session[]>([
    {
      id: 1,
      title: "Advice regarding stocks",
      date: "11/09/2025",
      messages: [
        { role: "assistant", content: "Hello! I can help you analyze compliance questions.", timestamp: new Date().toISOString() },
      ],
    },
  ]);
  ...
  const addSession = () => {
    const newSession: Session = {
      ...
      messages: [
        { role: "assistant", content: "Hello! I'm your Risk & Compliance Advisor. How can I assist you today?", timestamp: new Date().toISOString() },
      ],
    };
